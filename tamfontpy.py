...
class tamfont:
 ...
 def tam(self):
  ...
  for index, unik in enumerate(txt):
    ...
    if ord(unik) == 3014 or ord(unik) == 3015 or ord(unik) == 3016 or ord(unik) == 3018 or  ord(unik) == 3019 or  ord(unik) == 3020:
  ...
  #யீ
   ...
   #ஸீ
    ...
    output =  output + "\u0c48"
   #ஸ்ரீ
   elif ord(txt[index]) == 3000 and ord(txt[index+1]) == 3021 and ord(txt[index+2]) == 2992 and ord(txt[index+3]) == 3008:
    output =  output + "\u0c46"
  ...
  #ஷி
   ...
   elif ord(txt[index]) == 3007 or  ord(txt[index]) == 3008 or ord(txt[index]) == 3009 or ord(txt[index]) == 3010:
